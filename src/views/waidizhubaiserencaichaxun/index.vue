        ...
        <div class="box">
            <el-form class="search-form" label-position="top" label-width="80px" :model="searchForm">
                ...
                <showMore :searchMore="searchMore">
                    ...
                    <el-col :span="6">
                        <el-form-item label="挂职职称">
                            <el-input size="small" v-model="searchForm.region"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="挂职职务">
                            <el-input size="small" v-model="searchForm.region"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6">
                        <el-form-item label="挂职类型">
                            <el-input size="small" v-model="searchForm.region"></el-input>
                        </el-form-item>
                    </el-col>
                </showMore>
...
<script>
    import formModel from "../waidizhubaiserencaidaoru/formModel";
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    { name: '专业技术职称', key: 'date', check: true },
                    { name: '原工作单位', key: 'date', check: true },
                    { name: '原职务', key: 'date', check: true },
                    { name: '挂职单位', key: 'date' },
                    { name: '挂职职位', key: 'date' },
                    { name: '专业领域', key: 'date' },
                    { name: '挂职时间', key: 'date' },
