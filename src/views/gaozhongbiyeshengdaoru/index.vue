    ...
    <div class="index">
        ...
        <div class="box">
            <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="date" :width="160" label="批次号"></el-table-column>
                <el-table-column prop="date" :width="160" label="文件名称">
                    <template slot-scope="scope">
                        <a size="small" @click="handleDownloadFile(scope.row)">{{ scope.row.date }}</a>
                    </template>
                </el-table-column>
                <el-table-column prop="date" :width="160" label="总计导入人数"></el-table-column>
                <el-table-column prop="date" :width="160" label="成功导入人数"></el-table-column>
                <el-table-column prop="date" :width="160" label="失败导入人数"></el-table-column>
                <el-table-column prop="date" :width="160" label="状态"></el-table-column>
                <el-table-column prop="date" :width="160" label="原因"></el-table-column>
                <el-table-column prop="date" :width="160" label="导入人"></el-table-column>
                ...
                <el-table-column fixed="right" :width="220" align="center" label="操作">
                    <template slot-scope="scope">
                        <div class="btn-wrapper">
                            ...
                            <vs-button size="small" :disabled="scope.$index / 3 === 1" @click="handleDownloadFail(scope.row)">下载失败数据</vs-button>
                        </div>
                    </template>
                </el-table-column>
            </el-table>
