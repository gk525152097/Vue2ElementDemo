...
<script>
    import formModel from "../lvlingrencaidaoru/formModel";
        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    { name: '人才类型', key: 'date', check: true },
                    { name: '从事行业', key: 'date', check: true },
                    { name: '特殊技能', key: 'date', check: true },
                    { name: '联系电话', key: 'date', check: true },
                    { name: 'QQ/微信', key: 'date', check: true },
                    { name: '备注', key: 'date', check: true },
                    { name: '更新人员', key: 'date', check: true },
                    { name: '更新时间', key: 'date', check: true },
                ]
            }
        },
        computed: {
