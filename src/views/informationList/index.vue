    ...
    <div class="index">
        ...
        <div class="box">
            <el-table :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="date" label="资讯类型"></el-table-column>
                <el-table-column prop="date" label="资讯状态"></el-table-column>
                ...
                <el-table-column fixed="right" :width="220" align="center" label="操作">
                    <template slot-scope="scope">
                        <div class="btn-wrapper">
                            <vs-button size="small" @click="handleView(scope.row)">查看</vs-button>
